...
\section*{Egne kommandoer og pakker}
Lag en mappe som heter `local'. Her kan du lage filene \lstinline{commands.tex} og \lstinline{packages.tex} hvor du kan definere egne kommandoer og inkludere egne pakker.
