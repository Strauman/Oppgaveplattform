...
Kommandoer, utenom de som er definert i \lstinline{\reldir/lib/commands.tex}, er følgende spesielle kommandoer definert\\
\begin{tabularx}{\textwidth}{lX}
...
\lstinline|\reldir/lib/codestyle| bestemmer hvordan \lstinline|lstlistings| skal se ut. \lstinline|\reldir/lib/commands| inneholder kommandodefinisjoner, \lstinline|document| er logikken bak hvordan oppgavesett er implementert
\clearpage
