...
\newcommand{\buildset}[0]{
  \IfFileExists{\ProblemSetDirectory\setNo}{
    ...
    \thispagestyle{empty}
    \begin{center}
        \IfLanguageName{english}{{\Huge\color{red}\textbf{File \ProblemSetDirectory\setNo.tex not found}}}{}
        \IfLanguageName{norsk}{{\Huge\color{red}\textbf{Fil \ProblemSetDirectory\setNo.tex finnes ikke}}}{}
    \end{center}
    \addtocounter{page}{-1}
    \clearpage
  }
